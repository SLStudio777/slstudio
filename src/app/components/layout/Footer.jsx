        ...
        <footer className="mt-10 border-t border-white/5 bg-[#1b1b1b]">
            <div className="container py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-3 text-white/65 mt-2">
                ...
                <div className="flex flex-col gap-3">
                    <p className="text-white/75 text-xs uppercase tracking-[0.2em] mb-2">Navigation</p>
                ...
                {/* Right — Contact */}
                <div className="flex flex-col gap-3">
                    <p className="text-white/75 text-xs uppercase tracking-[0.2em] mb-2">Get In Touch</p>
                    ...
                    <p className="text-white/65 text-sm mt-2">Warsaw, Poland</p>
                    <p className="text-white/65 text-sm">Worldwide Remote</p>
                </div>
            </div>

            {/* Bottom */}
            <div className="border-t border-white/5">
                <div className="container py-4 text-xs text-white/75 flex justify-between">
