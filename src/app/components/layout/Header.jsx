    ...
    return (
        <nav ref={navRef} className="sticky top-0 z-50 bg-[#1b1b1b]/80 backdrop-blur-xs border-b border-white/5">
            ...
            <div className="container py-4 flex items-center justify-between">
                ...
                <ul className="flex items-center gap-6 text-white/70 text-base font-medium tracking-wide max-[1080px]:hidden">
                    <li className="beam-group flex items-center gap-0">
                        ...
                        <Link href="/tape-room" onClick={handleNav("/tape-room")} className="beam-btn beam-glow px-3 py-2 font-medium whitespace-nowrap" style={{ color: "#e8c97a", border: "1px solid transparent", borderLeft: "none", background: "linear-gradient(90deg, rgba(201,168,76,0.075) 0%, rgba(201,168,76,0.09) 50%, rgba(201,168,76,0.105) 100%) padding-box, linear-gradient(90deg, rgba(201,168,76,0.105) 0%, rgba(201,168,76,0.135) 100%) border-box" }}>Tape Room</Link>
                        <Link href="/blog" onClick={handleNav("/blog")} className="beam-btn beam-glow px-4 py-2 font-medium whitespace-nowrap" style={{ color: "#e6dbbb", border: "1px solid transparent", borderLeft: "none", background: "linear-gradient(90deg, rgba(201,168,76,0.105) 0%, rgba(201,168,76,0.12) 50%, rgba(201,168,76,0.135) 100%) padding-box, linear-gradient(90deg, rgba(201,168,76,0.135) 0%, rgba(201,168,76,0.165) 100%) border-box" }}>Blog</Link>
                        <Link href="/about" onClick={handleNav("/about")} className="beam-btn beam-glow px-4 py-2 font-medium whitespace-nowrap" style={{ color: "#ecdcaa", border: "1px solid transparent", borderLeft: "none", background: "linear-gradient(90deg, rgba(201,168,76,0.135) 0%, rgba(201,168,76,0.18) 50%, rgba(201,168,76,0.24) 100%) padding-box, linear-gradient(90deg, rgba(201,168,76,0.165) 0%, rgba(201,168,76,0.23) 100%) border-box" }}>About</Link>
                        <Link href="/contact" onClick={handleNav("/contact")} className="beam-btn beam-glow px-4 py-2 rounded-r-lg font-medium whitespace-nowrap" style={{ color: "#f4e9c4", border: "1px solid transparent", borderLeft: "none", background: "linear-gradient(90deg, rgba(201,168,76,0.24) 0%, rgba(201,168,76,0.32) 50%, rgba(201,168,76,0.42) 100%) padding-box, linear-gradient(90deg, rgba(201,168,76,0.23) 0%, rgba(201,168,76,0.34) 100%) border-box", textShadow: "0 1px 2px rgba(0,0,0,0.35)" }}>Contact</Link>
                ...
                <button onClick={() => setOpen(!open)} className="min-[1081px]:hidden flex flex-col justify-center items-center gap-[5px] w-8 h-8" aria-label="Menu">
            ...
            {open && (
                <div className="min-[1081px]:hidden border-t border-white/5 bg-[#1b1b1b]">
                    <ul className="container py-4 flex flex-col gap-3 text-white/70 text-base font-medium">
                        <li className="flex flex-col items-stretch gap-0 pt-1">
                            ...
                            <Link href="/tape-room" onClick={handleNav("/tape-room", true)} className="beam-btn beam-glow px-4 py-2 font-medium" style={{ color: "#e8c97a", border: "1px solid transparent", borderTop: "none", background: "linear-gradient(180deg, rgba(201,168,76,0.075) 0%, rgba(201,168,76,0.09) 50%, rgba(201,168,76,0.105) 100%) padding-box, linear-gradient(180deg, rgba(201,168,76,0.105) 0%, rgba(201,168,76,0.135) 100%) border-box" }}>Tape Room</Link>
                            <Link href="/blog" onClick={handleNav("/blog", true)} className="beam-btn beam-glow px-4 py-2 font-medium" style={{ color: "#e6dbbb", border: "1px solid transparent", borderTop: "none", background: "linear-gradient(180deg, rgba(201,168,76,0.105) 0%, rgba(201,168,76,0.12) 50%, rgba(201,168,76,0.135) 100%) padding-box, linear-gradient(180deg, rgba(201,168,76,0.135) 0%, rgba(201,168,76,0.165) 100%) border-box" }}>Blog</Link>
                            <Link href="/about" onClick={handleNav("/about", true)} className="beam-btn beam-glow px-4 py-2 font-medium" style={{ color: "#ecdcaa", border: "1px solid transparent", borderTop: "none", background: "linear-gradient(180deg, rgba(201,168,76,0.135) 0%, rgba(201,168,76,0.18) 50%, rgba(201,168,76,0.24) 100%) padding-box, linear-gradient(180deg, rgba(201,168,76,0.165) 0%, rgba(201,168,76,0.23) 100%) border-box" }}>About</Link>
                            <Link href="/contact" onClick={handleNav("/contact", true)} className="beam-btn beam-glow px-4 py-2 rounded-b-lg font-medium" style={{ color: "#f4e9c4", border: "1px solid transparent", borderTop: "none", background: "linear-gradient(180deg, rgba(201,168,76,0.24) 0%, rgba(201,168,76,0.32) 50%, rgba(201,168,76,0.42) 100%) padding-box, linear-gradient(180deg, rgba(201,168,76,0.23) 0%, rgba(201,168,76,0.34) 100%) border-box", textShadow: "0 1px 2px rgba(0,0,0,0.35)" }}>Contact</Link>
