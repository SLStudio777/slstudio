        ...
        <section className="max-w-5xl mx-auto relative">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
                <div className="flex flex-col gap-3">
                    ...
                    <p className="text-white/50 text-[15px] leading-relaxed max-w-sm mt-1">
                ...
                {/* Logo — right side of header, same level as Let's Work */}
                <div className="hidden md:block flex-shrink-0" style={{ width: "44%" }}>
                    <img
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
                ...
                <div className="flex flex-col gap-2">
                    <p className="text-white/25 text-xs uppercase tracking-widest mb-1">Connect directly</p>
                    ...
                    {contacts.map((c, i) => (
                        ...
                        >
                            <div className="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0" style={{ background:"rgba(201,168,76,0.1)", color:"#C9A84C" }}>
                                {c.icon}
                            </div>
                    ...
                    <div className="p-3.5 rounded-xl mt-auto" style={{ border:"1px solid rgba(255,255,255,0.05)", background:"rgba(255,255,255,0.02)" }}>
                ...
                <div className="flex flex-col h-full">
                    {sent ? (
                        <div className="flex flex-col items-center justify-center gap-4 text-center p-8 rounded-2xl flex-1" style={{ border:"1px solid rgba(201,168,76,0.2)", background:"rgba(201,168,76,0.04)" }}>
                        ...
                        <div className="rounded-2xl p-6 flex flex-col gap-4 flex-1" style={{ border:"1px solid rgba(255,255,255,0.06)", background:"rgba(255,255,255,0.015)" }}>
                            <p className="text-white/25 text-xs uppercase tracking-widest">Send a message</p>
                            <form onSubmit={e => { e.preventDefault(); setSent(true); }} className="flex flex-col gap-4 flex-1">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex flex-col gap-2">
                                        <label className="text-white/40 text-xs uppercase tracking-widest">Name</label>
                                        <input type="text" placeholder="John Smith" required className="rounded-xl px-4 py-3 text-sm text-white placeholder:text-white/20 focus:outline-none transition" style={{ background:"rgba(255,255,255,0.03)", border:"1px solid rgba(255,255,255,0.07)" }} onFocus={e=>e.target.style.border="1px solid rgba(201,168,76,0.4)"} onBlur={e=>e.target.style.border="1px solid rgba(255,255,255,0.07)"}/>
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        <label className="text-white/40 text-xs uppercase tracking-widest">Email</label>
                                        <input type="email" placeholder="john@email.com" required className="rounded-xl px-4 py-3 text-sm text-white placeholder:text-white/20 focus:outline-none transition" style={{ background:"rgba(255,255,255,0.03)", border:"1px solid rgba(255,255,255,0.07)" }} onFocus={e=>e.target.style.border="1px solid rgba(201,168,76,0.4)"} onBlur={e=>e.target.style.border="1px solid rgba(255,255,255,0.07)"}/>
                                    </div>
                                </div>
                                <div className="flex flex-col gap-2">
                                    <label className="text-white/40 text-xs uppercase tracking-widest">Service</label>
                                    <select required style={{ colorScheme:"dark", background:"#1b1b1b", border:"1px solid rgba(255,255,255,0.07)" }} className="rounded-xl px-4 py-3 text-sm text-white focus:outline-none transition" onFocus={e=>e.target.style.border="1px solid rgba(201,168,76,0.4)"} onBlur={e=>e.target.style.border="1px solid rgba(255,255,255,0.07)"}>
                                ...
                                <div className="flex flex-col gap-2 flex-1">
                                    ...
                                    <textarea placeholder="Genre, what you have recorded, what you are going for..." required className="rounded-xl px-4 py-3 text-sm text-white placeholder:text-white/20 focus:outline-none transition resize-none flex-1" style={{ background:"rgba(255,255,255,0.03)", border:"1px solid rgba(255,255,255,0.07)", minHeight:"120px" }} onFocus={e=>e.target.style.border="1px solid rgba(201,168,76,0.4)"} onBlur={e=>e.target.style.border="1px solid rgba(255,255,255,0.07)"}/>
                                </div>
                                <button type="submit" className="flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-semibold text-black transition hover:opacity-90 mt-auto" style={{ background:"linear-gradient(135deg, #C9A84C 0%, #e8c97a 50%, #C9A84C 100%)", backgroundSize:"200% auto" }} onMouseEnter={e=>e.currentTarget.style.backgroundPosition="right center"} onMouseLeave={e=>e.currentTarget.style.backgroundPosition="left center"}>
