        ...
        <section className="max-w-5xl mx-auto relative">
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-10">
                <div className="flex flex-col gap-3">
                    ...
                    <p className="text-white/50 text-[15px] leading-relaxed max-w-xl mt-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    {contacts.map((c, i) => (
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-white/50 text-sm truncate">{c.handle}</p>
                            </div>
                            <ArrowUpRight className="w-4 h-4 flex-shrink-0 opacity-30 group-hover:opacity-70 transition"
                                style={{ color: "#C9A84C" }} />
                        </a>
                    ))}
                    ...
                    <div className="p-4 rounded-xl mt-1"
                        ...
                        <div className="flex items-center gap-2 mb-1.5">
                            <div className="w-2 h-2 rounded-full" style={{ background: "#C9A84C", boxShadow: "0 0 6px rgba(201,168,76,0.6)", animation: "pulse 2s ease-in-out infinite" }}/>
                ...
                <div>
                    {sent ? (
                        <div className="flex flex-col items-center justify-center gap-4 text-center p-8 rounded-2xl h-full"
                        ...
                        <div className="rounded-2xl p-6 flex flex-col gap-4"
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <select
                                        required
                                        style={{ colorScheme: "dark", background: "#1b1b1b", border: "1px solid rgba(255,255,255,0.07)" }}
                                ...
                                <button
                                    type="submit"
                                    className="flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-semibold text-black transition hover:opacity-90"
                                    style={{ background: "linear-gradient(135deg, #C9A84C 0%, #e8c97a 50%, #C9A84C 100%)", backgroundSize: "200% auto" }}
