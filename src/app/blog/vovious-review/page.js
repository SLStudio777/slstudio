            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="flex flex-col gap-10 text-white/70 text-[15px] leading-relaxed">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p>Vovious uses a different approach: <strong className="text-white">FFT-based analysis (frequency domain)</strong> combined with a neural network for pitch detection. The neural network is trained to identify the stable tonal center of a note rather than chasing every micro-fluctuation in pitch. The result is that the plugin corrects pitch without touching the overtone structure of the voice — which is exactly why corrections sound natural even when aggressive.</p>
                        <p>The neural network is also what drives the color-coded visualization: the model is continuously analyzing pitch confidence, and the color (blue = in tune, purple = close, red = needs attention) reflects that confidence score in real time. It is not cosmetic — it is the model telling you where it is certain and where it is guessing.</p>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p>The test material: a blues-rock vocal with a wide dynamic range, some intentional slides, and notably sibilant consonants. No de-essing before the test. Neutral compressor applied, no saturation. Same correction amount applied across all four plugins.</p>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-4">
                            {[
                                ...
                                {
                                    title: "Speed",
                                    body: "Between the color coding and streamlined controls, tuning a typical vocal takes roughly 60–70% of the time it takes in Melodyne. After a week of daily use, I was reaching for it first without thinking about it."
                                },
                                {
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="rounded-xl p-5 flex flex-col gap-3" style={{background: "rgba(255,80,80,0.04)", border: "1px solid rgba(255,80,80,0.12)"}}>
                            <ul className="flex flex-col gap-3 text-white/60 text-sm">
                                ...
                                <li>→ <strong className="text-white">Enharmonic note display.</strong> The plugin uses sharps where the key calls for flats. In a session in Eb major, you see D# instead of Eb. Minor issue for experienced editors, genuinely confusing for beginners.</li>
