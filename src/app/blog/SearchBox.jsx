        ...
        <div className="relative flex-1 max-w-md">
            ...
            {query && (
                <button
                    ...
                    className="absolute right-2.5 top-1/2 -translate-y-1/2 w-6 h-6 flex items-center justify-center rounded-full text-white/65 hover:text-white/80 hover:bg-white/10 transition"
                >
