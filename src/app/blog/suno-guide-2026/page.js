            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="flex flex-col gap-14 text-white/70 text-[15px] leading-relaxed">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <p>Notice what is <em>not</em> in these prompts: five adjectives per word, Wikipedia-style genre histories, and a list of every instrument known to humanity. Keep it clean. The simpler your source material, the easier it is to work with later. This is true in recording, in mixing, and in AI prompting.</p>
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <p>The underlying logic here is important: every song is built from <strong className="text-white">repeating and contrasting sections</strong>. Verses build the story, choruses deliver the emotional payload, bridges shift the perspective, and instrumental sections control the energy flow. When you understand this, you stop thinking of a song as "a bunch of parts" and start thinking of it as a designed emotional experience. That is the difference between a demo and a release.</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="rounded-xl p-5 flex flex-col gap-3" style={{background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)"}}>
                                ...
                                <p className="text-white/50 text-sm leading-relaxed">Leaner, faster, no patience for slow builds. Get to the chorus in the first 30 seconds. Reduce friction for impatient listeners who make decisions in the first 15 seconds. Streaming data shows most people decide whether to stay within the intro — which means your intro is actually your chorus.</p>
                            </div>
                        </div>
                        ...
                        <div className="rounded-xl p-4 flex gap-3 items-start" style={{background: "rgba(201,168,76,0.06)", border: "1px solid rgba(201,168,76,0.15)"}}>
                            ...
                            <div>
                                ...
                                <p className="text-white/60 text-sm leading-relaxed">Start with an instrumental intro. Give your track space to breathe before the vocal comes in. It creates anticipation, sounds more professional, and gives you clean, vocal-free material to work with when you get to the DAW. A track that starts with silence for two beats feels more intentional than one that hits immediately.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="rounded-xl p-5 flex flex-col gap-3" style={{background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)"}}>
                                ...
                                <p className="text-white/50 text-sm leading-relaxed"><strong className="text-white">Middle</strong> — the working zone. A little weirdness creates interesting, unexpected touches without derailing the whole track. This is where most usable results live.</p>
                            ...
                            <div className="rounded-xl p-5 flex flex-col gap-3" style={{background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)"}}>
                                ...
                                <p className="text-white/50 text-sm leading-relaxed"><strong className="text-white">Too low</strong> — too much improvisation. The style drifts away from what you defined mid-track. The beginning sounds like what you asked for; the second half sounds like something else entirely.</p>
                                <p className="text-white/50 text-sm leading-relaxed"><strong className="text-white">Too high</strong> — stiff and mechanical. No breathing room. The result technically matches your description but feels lifeless, like a very obedient robot playing music it does not understand.</p>
                                <p className="text-white/50 text-sm leading-relaxed"><strong className="text-white">Middle ground</strong> — you want a result that is usable, not a demonstration of edge cases. Give the tool room to interpret while keeping it on the right track.</p>
                            </div>
                        </div>
                        ...
                        <div className="rounded-xl p-4 flex gap-3" style={{background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.08)"}}>
                            ...
                            <p className="text-white/60 text-sm leading-relaxed">The underlying principle here is simple: <strong className="text-white">the more chaos you introduce at the generation stage, the harder it is to work with the output later.</strong> A clean, slightly predictable source track is infinitely more valuable than a "unique" piece of noise that you cannot mix, extend, or build on. Generate clean, get creative in the DAW.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <p>Suno works best when you <strong className="text-white">develop what you have found</strong> rather than constantly searching for something new. The goal is refinement, not lottery. A musician who rewrites the same song twenty times makes something great. A musician who writes twenty different songs in a weekend makes twenty demos.</p>
                    </div>
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="rounded-xl p-5 flex gap-4 items-start" style={{background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderLeft: "3px solid #C9A84C"}}>
                                ...
                                <div>
                                    ...
                                    <p className="text-white/50 text-sm leading-relaxed">Extend continues an existing track while preserving its character. It is not a new generation — it is a continuation. The sound stays consistent, the vibe carries through, and you get longer, more cohesive material to work with. This is especially valuable when you have a great verse but the track cuts off before the chorus, or when you want to build out a longer arrangement for mixing. Every time you would generate a new track from scratch because the existing one is too short, use Extend instead.</p>
                                </div>
                            </div>
                            <div className="rounded-xl p-5 flex gap-4 items-start" style={{background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderLeft: "3px solid #C9A84C"}}>
                                <span className="text-xl flex-shrink-0">🔄</span>
                                <div>
                                    ...
                                    <p className="text-white/50 text-sm leading-relaxed">Cover creates an alternative version of the same idea — different delivery, different feel, same underlying DNA. This is not a cover song in the traditional sense. Think of it as giving the same script to a different actor and seeing what happens. Sometimes the alternative surprises you in a way that serves the song better than the original. Use it when you like the structure but something about the execution is not quite right — maybe the vocal character, maybe the energy level, maybe the instrumental texture.</p>
                                </div>
                            </div>
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <p>Think about what this means in practice: you have been working on an album. Every track needs to sound like it belongs to the same world — same vocal character, same sonic palette, same energy. Without Personas, every session starts from zero and you hope the results converge naturally. With Personas, you anchor the sound and build from there. Consistency is not a creative limitation. It is what makes an album feel like an album.</p>

                        <div className="rounded-xl p-4 flex gap-3" style={{background: "rgba(201,168,76,0.06)", border: "1px solid rgba(201,168,76,0.15)"}}>
                            <span className="text-lg">🎯</span>
                            <p className="text-white/60 text-sm leading-relaxed">Personas are especially useful for <strong className="text-white">album projects, YouTube channels, and client work</strong> — anywhere you need your music to have a recognizable, coherent sound across multiple pieces. Once you have a Persona that works, it is one of the most valuable things in your Suno workspace.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="rounded-2xl p-6 flex flex-col gap-3" style={{background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.08)"}}>
                            {[
                                {check: "I know what I am going for", note: "A direction, not a wish. 'I want something that sounds cool' is not a direction."},
                                {check: "Started in Simple Mode", note: "To find the direction first. Custom Mode can wait."},
                                {check: "Prompt order is correct", note: "Genre & mood → vocals → instruments → mix feel."},
                                {check: "No contradictions in the prompt", note: "If two elements conflict, Suno will guess which one you meant. You will not like the guess."},
                                {check: "Vocals are described", note: "Even one line. Gender, delivery, emotional quality."},
                                {check: "Only key instruments listed", note: "Not every instrument you have ever heard. The essentials."},
                                {check: "Structure tags are in [brackets]", note: "Not in the lyrics. In brackets."},
                                {check: "Weirdness & Style Influence around the middle", note: "Not maximum. Never maximum."},
                                {check: "If I have a good take — Extend or Cover first", note: "Do not throw away working material to chase something new."},
                                {check: "I remember: Suno output is a demo", note: "The DAW finishes the job. Always."},
                            ].map((item, i) => (
                                <div key={i} className="flex items-start gap-3 py-2" style={{borderBottom: i < 9 ? "1px solid rgba(255,255,255,0.04)" : "none"}}>
                    ...
                    {/* Final thought */}
                    <div className="rounded-2xl p-8 flex flex-col gap-4" style={{background: "rgba(201,168,76,0.06)", border: "1px solid rgba(201,168,76,0.2)"}}>
                        ...
                        <p className="text-white/60 text-sm leading-relaxed">The musicians who get the most out of Suno are not the ones who found the magic prompt. They are the ones who understood the logic, built a workflow, and kept showing up. They are the ones who treat it like a collaborator rather than a vending machine.</p>
                        ...
                        <p className="text-white font-semibold mt-2">Now go make something.</p>
                    </div>
